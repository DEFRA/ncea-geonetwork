...
package org.fao.geonet.schema.iso19139_mdc;
...
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.GCO;
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.GMD;
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.MDC;
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.GMX;
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.SRV;
import static org.fao.geonet.schema.iso19139_mdc.ISO19139MDCNamespaces.XLINK;

/**
 * Created by francois on 6/15/14.
 */
public class ISO19139MDCSchemaPlugin
    ...
    public static final String IDENTIFIER = "iso19139.mdc";
    ...
    static {
        ...
        allExportFormats = ImmutableMap.<String, String>builder()
            // This is more for all basic iso19139.mdc profiles using this bean as default
            // The conversion is not available in regular iso19139.mdc plugin.
            // This is for backward compatibility.
            .put("convert/to19139.xsl", "metadata-iso19139.xml")
            .build();
    }

    public ISO19139MDCSchemaPlugin() {
    ...
    public static List<String> getLanguages(Element md) {
        ...
        try {
            ...
            List<Attribute> locales = (List<Attribute>) Xml.selectNodes(md, "gmd:locale/*/gmd:languageCode/*/@codeListValue", ISO19139MDCSchemaPlugin.allNamespaces.asList());
            if (locales != null) {
                locales.stream()
    ...
    public <L, M> RawLinkPatternStreamer<L, M> createLinkStreamer(ILinkBuilder<L, M> linkbuilder, String excludePattern) {
        ...
        patternStreamer.setNamespaces(ISO19139MDCSchemaPlugin.allNamespaces.asList());
    ...
    private static String getMainLanguage(Element md) throws JDOMException {
        Attribute mainLanguageAttribute = (Attribute) Xml.selectSingle(md, "gmd:language/*/@codeListValue", ISO19139MDCSchemaPlugin.allNamespaces.asList());
        if (mainLanguageAttribute != null && StringUtils.isNotEmpty(mainLanguageAttribute.getValue())) {
            return mainLanguageAttribute.getValue();
        }

        Element mainLanguageElem = (Element) Xml.selectSingle(md, "gmd:language/*", ISO19139MDCSchemaPlugin.allNamespaces.asList());
